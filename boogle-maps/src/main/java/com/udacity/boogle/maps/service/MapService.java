...
public class MapService {
    ...
    public Address saveAddress(Long vehicleId) {
        Optional<Address> savedAddress = addressRepository.getAddressByVehicleId(vehicleId);
        Address addressToBeSaved = getRandom(vehicleId);
        if (savedAddress.isPresent()) {
            savedAddress.map( address -> {
                Long id = address.getId();
                addressToBeSaved.setId(id);
    ...
    public Address getAddressByVehicleId(Long vehicleId) {
        return addressRepository.getAddressByVehicleId(vehicleId).orElseThrow();
    }
    ...
    private Address getRandom(Long vehicleId) {
        ...
        return new Address(streetAndNumber, city, state, zip,vehicleId);
    }
